...
export declare class TpmSecurityClient {
    ...
    private _createPersistentPrimary(name, hierarchy, handle, template, callback);
    private _readPersistentPrimary(name, handle, callback);
    private _getPropsAndHashAlg(callback);
    private _signData(dataToSign, callback);
    private _activateIdentityKey(activationBlob, activateCallback);
}
