 ...
 * @private
 */
var PollingStateMachine = (function (_super) {
                        ...
                        if (err) {
                            ...
                            switch (result.status.toLowerCase()) {
                                ...
                                case 'assigning': {
                                    ...
                                    _this.emit('operationStatus', result);
    ...
    PollingStateMachine.prototype.cancel = function (callback) {
        debug('cancel called');
        this._fsm.handle('cancel', new azure_iot_common_1.errors.OperationCancelledError(''), callback);
    };
